...
{
    public function test_load_authentication()
    {
    ...
    /*
     * @depends load_authentication
     * */
    public function est_setUp()
    {
        try {
            $this->test_load_authentication();
        }catch (Exception $e)
        {
            throw new $e;
        }
     ...
     * @depends test_setUp
     * */
    function est_auth_0119192020(){
        $this->do_checks("01-1919-2020");
    }
    function est_auth_0111002211(){
        $this->do_checks("01-1100-2211");
    }
    function est_auth_0177889900(){
        $this->do_checks("01-7788-9900");
    }

    function est_auth_0133445566(){
        $this->do_checks("01-3344-5566");
    }

    function est_auth_0160607070()
    {
        $this->do_checks("01-6060-7070");
    }
    function est_auth_900000000000()
    {
        $this->do_checks("9-0000-0000-000");
    }
    function est_auth_100000000000()
    {
        $this->do_checks("100000000000");
    }
    function est_auth_0120203030()
    {
        $this->do_checks("01-2020-3030");
    }
    function est_auth_0110102020()
    {
        $this->do_checks("01-1010-2020");
    }
    function est_auth_500000000000(){
        $this->do_checks("500000000000");
    }
    function est_auth_0119192222()
    {
        $this->do_checks("01-1919-2222");
    }
    function est_auth_0140405050()
    {
        $this->do_checks("01-4040-5050");
    }
    function est_auth_0180809090()
    {
        $this->do_checks("01-8080-9090");
    }
    function est_auth_0119192121()
    {
