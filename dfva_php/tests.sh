...
#./phpunit.phar authentication.php --dont-report-useless-tests --debug --verbose

echo "###Pruebas unitarias de authentication.php terminadas.###"
./phpunit.phar TestValidateDocuments validation.php --dont-report-useless-tests --verbose --debug
echo "###Pruebas unitarias de la clase TestValidateDocuments de validation.php terminadas.###"
#./phpunit.phar TestValidateCertificates validation.php --dont-report-useless-tests --verbose --debug
echo "###Pruebas unitarias de la clase TestValidateCertificates de validation.php terminadas.###"
#./phpunit.phar signer.php --dont-report-useless-tests --debug --verbose
